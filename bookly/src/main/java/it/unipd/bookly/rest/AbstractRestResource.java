...
public abstract class AbstractRestResource implements RestResource {
     ...
     */
    protected static final Logger LOGGER = LogManager.getLogger(AbstractRestResource.class,
     ...
     */
    protected AbstractRestResource(final String action, final HttpServletRequest req, final HttpServletResponse res, final Connection con) {
