...
public class DeleteBookDAO extends AbstractDAO<Boolean> {
    ...
    protected void doAccess() throws Exception {
        ...
        try {
            ...
            if (this.outputParam) {
                LOGGER.info("Book ID {} and all related data deleted successfully.", book_id);
            } else {
                LOGGER.warn("No book found with ID {}. Nothing was deleted.", book_id);
            }
            ...
            LOGGER.error("Error deleting book ID {}: {}. Transaction rolled back.", book_id, e.getMessage(), e);
            throw e;
        } finally {
            ...
            try {
                ...
                LOGGER.warn("Failed to restore autocommit state after deleting book ID {}.", book_id, e);
            }
        }
    }
}
