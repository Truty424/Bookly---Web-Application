<%@ page contentType="text/html;charset=UTF-8" language="java" %>
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <head>
      ...
      <!-- Components -->
      <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/components/table.css"
        type="text/css" />
      <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/components/forms.css"
        type="text/css" />

      <!-- Page-specific -->
      <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/pages/manageAdmin.css"
        type="text/css" />
      <script src="${pageContext.request.contextPath}/static/js/validate-book.js"></script>
        ...
        <form action="${pageContext.request.contextPath}/admin/addBook" method="post" enctype="multipart/form-data">
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control rounded-3" id="language" name="language" required
            ...
            <div class="col-md-6">
              ...
              <input type="number" class="form-control rounded-3" id="price" name="price" step="0.01" required
                placeholder="Enter price" />
            </div>

            <div class="col-md-6">
              <label for="edition" class="form-label">Edition <small class="text-muted">(optional)</small></label>
            ...
            <div class="col-md-6">
              ...
              <input type="number" class="form-control rounded-3" id="publication_year" name="publication_year" required
                placeholder="Enter publication year" />
            </div>

            <div class="col-md-6">
              <label for="number_of_pages" class="form-label">Number of Pages</label>
              <input type="number" class="form-control rounded-3" id="number_of_pages" name="number_of_pages" required
            ...
            <div class="col-md-12">
              <label for="summary" class="form-label">Summary <small class="text-muted">(optional)</small></label>
              <textarea class="form-control rounded-3" id="summary" name="summary" rows="4"
