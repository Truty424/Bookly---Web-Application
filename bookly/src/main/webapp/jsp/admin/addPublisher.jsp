    ...
    <body>
      <div class="container py-5">
        <div class="mb-4 d-flex justify-content-between align-items-center">
          ...
          <a href="${pageContext.request.contextPath}/admin/dashboard" class="btn btn-light border btn-custom">
            Back to Dashboard
          </a>
        </div>

        <form action="${pageContext.request.contextPath}/admin/addPublisher" method="post">
          <div class="row g-3">
            <div class="col-md-6">
              <label for="publisher_name" class="form-label">Publisher Name</label>
              <input type="text" class="form-control rounded-3" id="publisher_name" name="publisher_name" required
            ...
            <div class="col-md-6">
              <label for="bookIds">Assign Books <small class="text-muted">(optional)</small></label>
              <select class="form-control" id="bookIds" multiple name="bookIds" size="5">
