          ...
          <div class="cart-book-cell">
            ...
            <div class="book-details">
              ...
              <div class="book-price">
                <span data-format="price">${book.price}</span>
              </div>
            </div>
          </div>
        </c:forEach>
      ...
      <div class="checkout-right">
        ...
        >
          ...
          <div id="credit-card-fields" style="display: none">
            ...
            <div class="row my-2">
              <div
                class="form-group d-flex justify-content-center align-items-center gap-2 my-2"
              >
          ...
          <p>
            ...
            <span data-format="price">${final_total}</span>
          </p>
