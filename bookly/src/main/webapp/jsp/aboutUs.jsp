...
<html>
  <head>
    ...
    <link
      rel="stylesheet"
      href="<%= request.getContextPath() %>/static/css/base/root.css"
      type="text/css"
    />
    <link
      rel="stylesheet"
      href="<%= request.getContextPath() %>/static/css/base/globals.css"
      type="text/css"
    />
    <link
      rel="stylesheet"
      href="<%= request.getContextPath() %>/static/css/pages/aboutUs.css"
      type="text/css"
    />
  </head>
  <body>
    ...
    <div class="container py-5">
      ...
      <p>
        Welcome to Bookly! We are a team of four students from the University of
        Padua, brought together by a shared passion for literature and digital
        innovation. This website was created as part of our Web Application
        course project, where we aimed to design a functional and user-friendly
        platform for discovering and purchasing books online.
      </p>
      <p>
      ...
      <div class="team-grid">
        ...
        <div class="team-card">
          ...
          <a href="https://www.linkedin.com/" target="_blank" class="team-link">
            <i class="fa-brands fa-linkedin"></i>
          </a>
        </div>
      </div>
