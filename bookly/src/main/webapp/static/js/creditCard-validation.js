...
function formatCardNumber(input) {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    autoTab(document.querySelector("input[name='cardNumber']"), "input[name='expiry']", 19);
    autoTab(document.querySelector("input[name='expiry']"), "input[name='cvv']", 5);
    setupFormValidation();
  });
